...
//        buttonGetColumns.disableProperty().bind(validRange.not());
    ...
    void buttonSortAction(ActionEvent event) {
        mainController.sortRange(new SortDto(boundariesDto, columToSort), new Callback() {
            @Override
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if (response.code() != 200) {
                    ...
                    Platform.runLater(() -> mainController.getSortedSheetRunLater(responseDto));
                }
            }
        });
    }
